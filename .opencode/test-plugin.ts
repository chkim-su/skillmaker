...
async function testSkillActivation() {
  ...
  const plugin = await SkillActivation(mockContext as any)
...
async function testSkillAccessGuard() {
  ...
  const plugin = await SkillAccessGuard(mockContext as any)
...
async function testPatternCompliance() {
  ...
  const plugin = await PatternCompliance(mockContext as any)
